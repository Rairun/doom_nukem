...
# define WOLF_C			"maps/wolf_classic.file"
# define TEST_C			"maps/test_map.file"
# define LABYRINTH_C	"maps/labyrinth.file"
# define DOOM_C			"maps/doom_map.file"
# define UNIT_C			"maps/unit_map.file"
...
# define ENEMY			3
# define WALL4			4
# define WALL_SYMB		"GWBPREMCLZXVNKJHFDATOYU4"
# define PLAYER_SYMB	'~'
# define SPRITE_SYMB	"blmatncdzrfyqp"
# define ENEMY_SYMB		"wg*"
...
# define FOG_DIST		15
# define FOG_DIST_FLR	11

# define BACK			0x00FFFF
...
void					check_map_wall(t_sdl *sdl, int i, int j,
						const char *line);
void					check_map_sprite(t_sdl *sdl, int i, int j,
						const char *line);
void					check_map_enemy(t_sdl *sdl, int i, int j,
						const char *line);
...
void					set_ceiling(t_sdl *sdl, const int k[5],
										unsigned int *pixels, int col);
int						fade_to_black(int col, double curr, double max);
double					line_length(double ax, double ay,
													double bx, double by);
